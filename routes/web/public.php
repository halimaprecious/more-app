...
use App\Http\Controllers\Web\Public\TestSmsController;
...
// HOMEPAGE
if (!doesCountriesPageCanBeHomepage()) {
	Route::get('/', [HomeController::class, 'alternative']);
	Route::get(dynamicRoute('routes.countries'), [CountriesController::class, 'index']);
} else {
	Route::get('/', [CountriesController::class, 'index']);
}
...
// Test message
Route::get('test-sms', [TestSmsController::class, 'smsMessage']); // TODO: Remove this line
