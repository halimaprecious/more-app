...
class SmsSetting
{
	public static function getValues($value, $disk)
	{
		if (empty($value)) {
			...
			$value['africa_talking_username'] = env('AFRICA_TALKING_USERNAME', '');
			$value['africa_talking_api_key'] = env('AFRICA_TALKING_API_KEY', '');
			$value['africa_talking_from'] = env('AFRICA_TALKING_FROM', '');
			$value['africa_talking_debug_to'] = env('AFRICA_TALKING_DEBUG_TO', '');
			$value['africa_talking_sms_url'] = env('AFRICA_TALKING_SMS_URL', '');
			...
			if (!array_key_exists('africa_talking_username', $value)) {
				$value['africa_talking_username'] = env('AFRICA_TALKING_USERNAME', '');
			}

			if (!array_key_exists('africa_talking_api_key', $value)) {
				$value['africa_talking_api_key'] = env('AFRICA_TALKING_API_KEY', '');
			}

			if (!array_key_exists('africa_talking_from', $value)) {
				$value['africa_talking_from'] = env('AFRICA_TALKING_API_FROM', '');
			}

			if (!array_key_exists('africa_talking_debug_to', $value)) {
				$value['africa_talking_debug_to'] = env('AFRICA_TALKING_DEBUG_TO', '');
			}

			if (!array_key_exists('africa_talking_sms_url', $value)) {
				$value['africa_talking_sms_url'] = env('AFRICA_TALKING_SMS_URL', '');
			}
	...
	public static function getFields($diskName)
	{
		$fields = [
			[
				...
				'attributes'        => [
					'id'       => 'phoneAsAuthField',
					'onchange' => 'enabledPhoneNumberAsAuthField(this)',
				],
				'wrapperAttributes' => [
					'class' => 'col-md-6',
				],
			...
			[
				'name'              => 'driver_africa_talking_title',
				'type'              => 'custom_html',
				'value'             => 'Africa\'s Talking',
				'wrapperAttributes' => [
					'class' => 'col-md-12 africa_talking',
				],
			],
			[
				'name'              => 'driver_africa_talking_info',
				'type'              => 'custom_html',
				'value'             => 'Get your Africa\'s Talking API Key from <a href="https://account.africastalking.com/apps/sandbox/sms" target="_blank">here</a> and your username from <a href="https://account.africastalking.com/apps/sandbox/sms" target="_blank">here</a>',
				'wrapperAttributes' => [
					'class' => 'col-md-12 africa_talking',
				],
			],
			[
				'name'              => 'africa_talking_username',
				'label'             => 'Africa\'s Talking Username',
				'type'              => 'text',
				'hint'              => 'Africa\'s Talking Username',
				'wrapperAttributes' => [
					'class' => 'col-md-6 africa_talking',
				],
			],
			[
				...
				'type'              => 'text',
				'hint'              => 'Africa\'s Talking API Key',
				'wrapperAttributes' => [
					'class' => 'col-md-6 africa_talking',
				],
			],
			[
				'name'              => 'africa_talking_from',
				'label'             => 'Africa\'s Talking Sender ID',
				'type'              => 'text',
				'hint'              => 'Africa\'s Talking Sender ID',
				'wrapperAttributes' => [
					'class' => 'col-md-6 africa_talking',
				],
			],
			[
				'name'              => 'africa_talking_debug_to',
				'label'             => 'Africa\'s Talking Debug To',
				'type'              => 'text',
				'hint'              => 'Africa\'s Talking Debug To',
				'wrapperAttributes' => [
					'class' => 'col-md-6 africa_talking',
				],
			],
			[
				'name'              => 'africa_talking_sms_url',
				'label'             => 'Africa\'s Talking SMS URL',
				'type'              => 'text',
				'hint'              => 'Africa\'s Talking SMS URL',
				'wrapperAttributes' => [
					'class' => 'col-md-6 africa_talking',
				],
			],
...
function getDriverFields(driverEl) {
	...
	hideEl(document.querySelectorAll(".vonage, .twilio, .africa_talking"));
	...
	if (driverElValue === "africa_talking") {
		showEl(document.querySelectorAll(".africa_talking"));
	}
}
</script>',
			],
...
docReady(function() {
	...
	enabledPhoneNumberAsAuthField(phoneAsAuthFieldEl);
});

function enabledPhoneNumberAsAuthField(phoneAsAuthFieldEl) {
