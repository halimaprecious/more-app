...
<head>
    ...
    <meta name="description" content="Discover a world of exclusive deals and unique products at Your Website Name. Explore a curated selection of top-notch items, from rare collectibles to cutting-edge gadgets, all in one place. Join our community of savvy shoppers and sellers today!" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:title" content="More Home page">
  <meta property="og:description" content="Discover a world of exclusive deals and unique products at Your Website Name. Explore a curated selection of top-notch items, from rare collectibles to cutting-edge gadgets, all in one place. Join our community of savvy shoppers and sellers today!.">
  <meta property="og:image" content="https://more.co.ke/assets/images/more.jpeg">
  <meta property="og:url" content="https://www.more.co.ke">
  <meta name="keywords" content="unleash the extraordinary, discover, explore, experience, hidden treasures, unique products, exclusive deals, exceptional services">
                    ...
                    <div class="nav-inner">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="login-button">
                                <ul>
                                    <li><a href="https://more.co.ke/search">
                                ...
                                <i class="lni lni-dollar"></i>
                                    Pricing</a></li>
                                    <li>
                                        <a href="https://more.co.ke/account/"><i class="lni lni-enter"></i> Login</a>
                                    </li>
                                    <li>
                                        <a href="https://more.co.ke/register"><i class="lni lni-user"></i>
                                        Register</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="button header-button">
                                <a href="https://more.co.ke/posts/create" class="btn">Got something to Sell? Post it Here</a>
                            </div>
                        </nav> <!-- navbar -->
                    </div>
                </div>
                ...
                <div class="col-lg-10 offset-lg-1 col-md-12 col-12">
                    <div class="hero-text text-center">
                        ...
                        <div class="section-heading">
                            ...
                            <p class="wow fadeInUp" data-wow-delay=".5s">Buy And Sell Everything Anywhere Anytime with ease and freedom on MORE</p>
                        </div>
                        <!-- End Search Form -->
                        <!-- Start Search Form -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".3s">Here are some of the latest products posted on our platform.</p>
                    </div>
                </div>
            </div>
            <?php
                    ...
                    foreach ($items as $item) {
                        echo '<div class="col-lg-4 col-md-6 col-12">
                            ...
                            <div class="single-grid wow fadeInUp" data-wow-delay=".4s">
                                <div class="image">
                                    <a href="' . $item['url'] . '" class="thumbnail" style="min-height: 300px; max-height: 300px; justify-content: center; align-items: center; display: flex;">
                                        <img src="' . $item['picture']['url']['full'] . '" alt="' . $item['title'] . '" style="max-height: 200px;  object-fit: contain;">
                                    </a>
                                    <div class="author">
                                ...
                                <div class="content">
                                    <div class="top-content">
                                        <a href="' . $item['url'] . '" class="tag">' . $item['category']['name'] . '</a>
                                        <h3 class="title">
                    ...
                    <div class="col-lg-3 col-md-6 col-12" style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                        ...
                        <div class="single-footer mobile-app">
                            <div class="logo" style="margin-left: 15px; margin-bottom: 15px">
                                <a href="/">
                                    <img src="https://more.co.ke/home/LOGO.jpg" alt="more" style="width: 110px; height: 60px;">
                                </a>
                            </div>
                            <div class="app-button">
                                ...
                                <ul class="footer-social" style="display: flex; flex-direction: row; justify-content: space-between; align-items: center; padding-right: 120px; font-size: 28px;">
                                    <li><a href="https://www.facebook.com/profile.php?id=100095028500208"><i class="lni lni-facebook-filled"></i></a></li>
                                    <li><a href="https://twitter.com/MoreClassifieds/status/1684123103599755264?s=20"><i class="lni lni-twitter-original"></i></a></li>
                                    <li><a href="javascript:void(0)"><i class="lni lni-youtube"></i></a></li>
                                    <li><a href="http://www.linkedin.com/in/more-classifieds-293244285"><i class="lni lni-linkedin-original"></i></a></li>
                                </ul>
