                ...
                @if (!config('settings.footer.hide_links'))
                                ...
                                @if ($socialLinksAreEnabled)
                                    <div class="col-sm-12 col-12 p-lg-0">
                                        <div class="{!! $footerSocialClass !!}">
                                            <span
                                                class="footer-title {!! $footerSocialTitleClass !!}">{{ t('Follow us on') }}</span>
                                            <ul
                    ...
                    <div class="col">
                        <div class="footer-col">
                            <span class="footer-title">{{ t('about_us') }}</span>
                    ...
                    <div class="col">
                        <div class="footer-col">
                            <span class="footer-title">{{ t('Contact and Sitemap') }}</span>
                            <ul class="list-unstyled footer-nav">
                    ...
                    <div class="col">
                        <div class="footer-col">
                            <span class="footer-title">{{ t('My Account') }}</span>
                            <ul class="list-unstyled footer-nav">
                                @if (!auth()->user())
                                    <li>
                                ...
                                @else
                                    ...
                                    <li><a href="{{ url('account/posts/favourite') }}"> {{ t('favourite_listings') }}
                                        </a></li>
                                @endif
                            </ul>
                        </div>
