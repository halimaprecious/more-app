							...
							<div class="col-12">
								...
								<form class="form-horizontal" id="postForm" method="POST" action="{{ url()->current() }}" enctype="multipart/form-data">
									...
									<fieldset>
										...
										<div id="areaBox" class="row mb-3">
											<label class="col-md-3 col-form-label" for="area_id">{{ t('location') }}</label>
											<div class="col-md-8">
												<select id="locationSelect" name="area_id" class="form-control large-data-selecter">
													<option value="0" @selected(empty(old('area_id')))>
														Select a location
													</option>
												</select>
											</div>
